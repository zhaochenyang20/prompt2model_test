...
unlimited_dataset_generator = OpenAIDatasetGenerator(
    initial_temperature=1.4, max_temperature=1.4, requests_per_minute=90, responses_per_request=5, filter_duplicated_examples=False
)
normalized_dataset = unlimited_dataset_generator.generate_dataset_split(
    prompt_spec, 5000, split=DatasetSplit.TRAIN
)
normalized_dataset.save_to_disk("./generated_dataset/normalization_1.4_1.4_without_filtering")
