...
task_name_list = [
    "normalization_1.4_1.4_with_filtering",
    "SQuAD_0.3_1.4_with_filtering",
    "jp2python",
]

# domenicrosati/QA2D-t5-base, lmqg/flan-t5-base-squad-qag for NQ

for model_name, task_name in product(
    model_name_list, ["normalization_1.4_1.4_with_filtering"]
):
